...
public class ImageViewTouchBase extends ImageView {
	...
	static final int ZOOM = 2;// 闁跨喐鏋婚幏鐑芥晸閺傘�?瀚�
	static final int ROTATE = 3;// 闁跨喐鏋婚幏鐤�?
	static final int ZOOM_OR_ROTATE = 4; // 闁跨喐鏋婚幏鐑芥晸閼存矮绱幏鐑芥晸閺傘倖�?归敓锟�	
