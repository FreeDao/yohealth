    ...
    implements HasViews, OnViewChangedListener
{
    ...
    public void onViewChanged(HasViews hasViews) {
        ...
        {
            View view = hasViews.findViewById(id.imgWeiBo);
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    @Override
                    public void onClick(View view) {
                        LoginActivity_.this.WeiBoLogin();
                    }
        ...
        {
            View view = hasViews.findViewById(id.imgQQ);
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
        ...
        {
            View view = hasViews.findViewById(id.tvReg);
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
