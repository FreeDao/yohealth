...
public class View_BigFlowerMonBabyBalanceData extends LinearLayout {
	Context mContext;
	@ViewById
	...
	public View_BigFlowerMonBabyBalanceData(Context context, MemberMDL mdl) {
		super(context);
		mContext = context;
		member = mdl;
	...
	public View_BigFlowerMonBabyBalanceData(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
		// init();
		// TODO Auto-generated constructor stub
